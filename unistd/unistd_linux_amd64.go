// Code generated by 'ccgo unistd/gen.c -D__signed__=signed -D__attribute__(x)= -ccgo-crt-import-path "" -ccgo-export-defines "" -ccgo-export-enums "" -ccgo-export-externs X -ccgo-export-fields F -ccgo-export-structs "" -ccgo-export-typedefs "" -ccgo-header -ccgo-long-double-is-double -ccgo-pkgname unistd -o unistd/unistd_linux_amd64.go', DO NOT EDIT.
...
type Off64_t = X__off64_t /* unistd.h:250:19 */
