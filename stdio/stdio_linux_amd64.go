// Code generated by 'ccgo /tmp/go-generate-230143997/x.c -ccgo-crt-import-path  -ccgo-export-defines  -ccgo-export-enums  -ccgo-export-externs X -ccgo-export-fields F -ccgo-export-structs  -ccgo-export-typedefs  -ccgo-pkgname stdio -o stdio/stdio_linux_amd64.go', DO NOT EDIT.
