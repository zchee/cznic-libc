// Code generated by 'ccgo dirent/gen.c -crt-import-path "" -export-defines "" -export-enums "" -export-externs X -export-fields F -export-structs "" -export-typedefs "" -hide _OSSwapInt16,_OSSwapInt32,_OSSwapInt64 -o dirent/dirent_windows_386.go -pkgname dirent', DO NOT EDIT.
...
type Va_list = X__builtin_va_list /* <builtin>:48:27 */
