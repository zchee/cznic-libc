// Code generated by 'ccgo sys/stat/gen.c -D__signed__=signed -ccgo-crt-import-path "" -ccgo-export-defines "" -ccgo-export-enums "" -ccgo-hide-asm -ccgo-export-externs X -ccgo-export-fields F -ccgo-export-structs "" -ccgo-export-typedefs "" -ccgo-long-double-is-double -ccgo-pkgname stat -o sys/stat/stat_linux_amd64.go', DO NOT EDIT.
