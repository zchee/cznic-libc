// Code generated by 'ccgo sys/stat/gen.c -D__signed__=signed -ccgo-crt-import-path "" -ccgo-export-defines "" -ccgo-export-enums "" -ccgo-hide-asm -ccgo-export-externs X -ccgo-export-fields F -ccgo-export-structs "" -ccgo-export-typedefs "" -ccgo-long-double-is-double -ccgo-pkgname stat -o sys/stat/stat_linux_arm.go', DO NOT EDIT.
...
type X__builtin_va_list = uintptr /* <builtin>:39:14 */
type X__float128 = float64        /* <builtin>:40:21 */
