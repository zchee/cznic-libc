// Code generated by 'ccgo sys/types/gen.c -D__signed__=signed -D__attribute__(x)= -ccgo-crt-import-path "" -ccgo-export-defines "" -ccgo-export-enums "" -ccgo-export-externs X -ccgo-export-fields F -ccgo-export-structs "" -ccgo-export-typedefs "" -ccgo-header -ccgo-long-double-is-double -ccgo-pkgname types -o sys/types/types_windows_amd64.go', DO NOT EDIT.
