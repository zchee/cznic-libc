// Code generated by 'ccgo fcntl/gen.c -D__signed__=signed -ccgo-crt-import-path "" -ccgo-export-defines "" -ccgo-export-enums "" -ccgo-hide-asm -ccgo-export-externs X -ccgo-export-fields F -ccgo-export-structs "" -ccgo-export-typedefs "" -ccgo-long-double-is-double -ccgo-pkgname fcntl -o fcntl/fcntl_linux_arm64.go', DO NOT EDIT.
