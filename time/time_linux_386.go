// Code generated by 'ccgo time/gen.c -D__signed__=signed -ccgo-crt-import-path "" -ccgo-export-defines "" -ccgo-export-enums "" -ccgo-hide-asm -ccgo-export-externs X -ccgo-export-fields F -ccgo-export-structs "" -ccgo-export-typedefs "" -ccgo-long-double-is-double -ccgo-pkgname time -o time/time_linux_386.go', DO NOT EDIT.
